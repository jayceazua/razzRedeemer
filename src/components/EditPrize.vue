...
<script>
    ...
    export default{
        ...
        methods: {
            getPrize() {
              let uri = 'https://damp-forest-70063.herokuapp.com/prizes/edit/' + this.$route.params.id;
            ...
            updatePrize() {
              let uri = 'https://damp-forest-70063.herokuapp.com/prizes/update/' + this.$route.params.id;
